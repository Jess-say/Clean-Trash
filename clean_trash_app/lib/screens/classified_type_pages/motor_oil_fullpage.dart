...
class MotorOilFullPage extends StatefulWidget {
  ...
  const MotorOilFullPage({Key? key, required this.recyclable})
      : super(key: key);
...
class _MotorOilFullPageState extends State<MotorOilFullPage> {
  @override
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              ...
                              child: Image.asset('assets/images/motor_oil.jpg'),
                            ),
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child:
                                  Image.asset('assets/images/motor_oil2.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child:
                                  Image.asset('assets/images/motor_oil3.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                              side: const BorderSide(
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child:
                                  Image.asset('assets/images/motor_oil1.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                              //side: const BorderSide(color: Color.fromARGB(255, 255, 254, 254), width: 1),
                              borderRadius: BorderRadius.circular(10),
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              widget.recyclable == "True"
                                  ? "Do not throw oil down the drain. Take it to a certified collection centers for recycling."
                                      "You may also call a curbside oil collection service."
                                  : "Place in waste bin.",
                              style: TextStyle(
                                fontSize: 18,
                                color: Colors.grey[500],
