...
class NormalPaperFullPage extends StatefulWidget {
  ...
  const NormalPaperFullPage({Key? key, required this.recyclable}) : super(key: key);
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child:
                              Image.asset('assets/images/paper3.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                              side: const BorderSide(
