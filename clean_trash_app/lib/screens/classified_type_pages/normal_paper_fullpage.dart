...
class NormalPaperFullPage extends StatefulWidget {
  final String recyclable;

  const NormalPaperFullPage({Key? key, required this.recyclable})
      : super(key: key);

  @override
  _NormalPaperFullPageState createState() => _NormalPaperFullPageState();
}

class _NormalPaperFullPageState extends State<NormalPaperFullPage> {
  @override
                      ...
                      children: [
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              ...
                              child: Image.asset('assets/images/paper4.jpg'),
                            ),
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child: Image.asset('assets/images/paper1.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child: Image.asset('assets/images/paper3.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                              side: const BorderSide(
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child: Image.asset('assets/images/paper2.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                              //side: const BorderSide(color: Color.fromARGB(255, 255, 254, 254), width: 1),
                              borderRadius: BorderRadius.circular(10),
