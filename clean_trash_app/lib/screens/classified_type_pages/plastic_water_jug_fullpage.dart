...
class PlasticWaterJugFullPage extends StatefulWidget {
  ...
  const PlasticWaterJugFullPage({Key? key, required this.recyclable})
      : super(key: key);

  @override
  _PlasticWaterJugFullPageState createState() =>
      _PlasticWaterJugFullPageState();
}
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child: Image.asset('assets/images/water3.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                              side: const BorderSide(
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child: Image.asset('assets/images/water4.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                              //side: const BorderSide(color: Color.fromARGB(255, 255, 254, 254), width: 1),
                              borderRadius: BorderRadius.circular(10),
