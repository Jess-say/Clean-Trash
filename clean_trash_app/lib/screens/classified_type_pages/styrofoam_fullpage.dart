...
class StyrofoamFullPage extends StatefulWidget {
  final String recyclable;

  const StyrofoamFullPage({Key? key, required this.recyclable})
      : super(key: key);

  @override
  _StyrofoamFullPageState createState() => _StyrofoamFullPageState();
}

class _StyrofoamFullPageState extends State<StyrofoamFullPage> {
  @override
  Widget build(BuildContext context) {
    ...
    try {
      if (widget.recyclable == 'True') {
        int num = Random().nextInt(polystyrene_list.length);
        // print(glass_list.length);
        message = polystyrene_list[num];
      } else {
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              ...
                              child: Image.asset(
                                  'assets/images/styrofoam_cup.jpg'),
                            ),
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child: Image.asset(
                                  'assets/images/styrofoam_container.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child: Image.asset(
                                  'assets/images/styrofoam_egg.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                              side: const BorderSide(
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child: Image.asset(
                                  'assets/images/styrofoam_package.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                              //side: const BorderSide(color: Color.fromARGB(255, 255, 254, 254), width: 1),
                              borderRadius: BorderRadius.circular(10),
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              widget.recyclable == "True"
                                  ? "Clean out any food residue. If styrofoam is stained throw away and only recycle clean styrofoam."
                                  : "Place in waste bin.",
                              style: TextStyle(
                                fontSize: 18,
                                color: Colors.grey[500],
