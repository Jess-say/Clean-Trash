...
class MetalCapFullPage extends StatefulWidget {
  final String recyclable;

  const MetalCapFullPage({Key? key, required this.recyclable})
      : super(key: key);

  @override
  _MetalCapFullPageState createState() => _MetalCapFullPageState();
}

class _MetalCapFullPageState extends State<MetalCapFullPage> {
  @override
                      ...
                      children: [
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              ...
                              child: Image.asset('assets/images/soda_cap.jpg'),
                            ),
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child: Image.asset('assets/images/caps.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child: Image.asset('assets/images/caps2.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                              side: const BorderSide(
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              widget.recyclable == "True"
                                  ? "Rinse caps with warm water to get rid of residue. Then place in recycling bin."
                                  : "Place in waste bin.",
                              style: TextStyle(
                                fontSize: 18,
                                color: Colors.grey[500],
