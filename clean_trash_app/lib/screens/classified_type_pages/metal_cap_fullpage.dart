...
class MetalCapFullPage extends StatefulWidget {
  ...
  const MetalCapFullPage({Key? key, required this.recyclable}) : super(key: key);
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child:
                              Image.asset('assets/images/caps2.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                              side: const BorderSide(
      ...
      Expanded(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Rise caps with warm water to get rid of residue. Then place in recycling bin",
              style: TextStyle(
                fontSize: 18,
                color: Colors.grey[500],
              ),
