...
class PaintcanFullPage extends StatefulWidget {
  ...
  const PaintcanFullPage({Key? key, required this.recyclable})
      : super(key: key);
...
class _PaintcanFullPageState extends State<PaintcanFullPage> {
  @override
                      ...
                      children: [
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              ...
                              child: Image.asset('assets/images/paint4.jpg'),
                            ),
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child: Image.asset('assets/images/paint.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child: Image.asset('assets/images/paint3.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                              side: const BorderSide(
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child: Image.asset('assets/images/paint2.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                              //side: const BorderSide(color: Color.fromARGB(255, 255, 254, 254), width: 1),
                              borderRadius: BorderRadius.circular(10),
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              widget.recyclable == "True"
                                  ? "If paint is oil based then dispose at a local Household Hazardous Waste facility."
                                      " If paint is latex based pour left over paint into box of litter and let it solidified then throw away the solidified paint."
                                      " Let the little left over paint in the can dry up then recycle with other metals."
                                  : "Place in waste bin.",
                              style: TextStyle(
                                fontSize: 18,
                                color: Colors.grey[500],
