...
class GlassCatsupFullPage extends StatefulWidget {
  ...
  const GlassCatsupFullPage({Key? key, required this.recyclable}) : super(key: key);
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child:
                              Image.asset('assets/images/tapatio.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                              side: const BorderSide(
