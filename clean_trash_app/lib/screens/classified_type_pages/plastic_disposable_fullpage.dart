...
class PlasticDisposableFullPage extends StatefulWidget {
  final String recyclable;

  const PlasticDisposableFullPage({Key? key, required this.recyclable})
      : super(key: key);

  @override
  _PlasticDisposableFullPageState createState() =>
      _PlasticDisposableFullPageState();
}

class _PlasticDisposableFullPageState extends State<PlasticDisposableFullPage> {
  @override
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              ...
                              child: Image.asset(
                                  'assets/images/disposable_plastic1.jpg'),
                            ),
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child: Image.asset(
                                  'assets/images/disposable_plastic2.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child: Image.asset(
                                  'assets/images/disposable_plastic4.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                              side: const BorderSide(
