...
class PlasticDisposableFullPage extends StatefulWidget {
  ...
  const PlasticDisposableFullPage({Key? key, required this.recyclable}) : super(key: key);
  
  @override
  _PlasticDisposableFullPageState createState() => _PlasticDisposableFullPageState();
}
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child:
                              Image.asset('assets/images/disposable_plastic4.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                              side: const BorderSide(
