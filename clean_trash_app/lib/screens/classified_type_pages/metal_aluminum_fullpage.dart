...
class AluminumFullPage extends StatefulWidget {
  final String recyclable;

  const AluminumFullPage({Key? key, required this.recyclable}) : super(key: key);
  
  @override
  _AluminumFullPageState createState() => _AluminumFullPageState();
}

class _AluminumFullPageState extends State<AluminumFullPage> {
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child: Image.asset(
                                  'assets/images/alum_container.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child:
                              Image.asset('assets/images/aluminum.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                              side: const BorderSide(
      ...
      Expanded(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "If possible clean off food residue by rinsing with warm water. Only recycle aluminum that is clean.",
              style: TextStyle(
                fontSize: 18,
                color: Colors.grey[500],
              ),
