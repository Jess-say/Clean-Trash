...
class MetalDrinkFullPage extends StatefulWidget {
  final String recyclable;

  const MetalDrinkFullPage({Key? key, required this.recyclable}) : super(key: key);
  
  @override
  _MetalDrinkFullPageState createState() => _MetalDrinkFullPageState();
}

class _MetalDrinkFullPageState extends State<MetalDrinkFullPage> {
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child:
                              Image.asset('assets/images/metal_juice.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                              side: const BorderSide(
