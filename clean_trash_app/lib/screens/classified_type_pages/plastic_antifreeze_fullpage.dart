...
class PlasticAntifreezeFullPage extends StatefulWidget {
  ...
  const PlasticAntifreezeFullPage({Key? key, required this.recyclable}) : super(key: key);
  
  @override
  _PlasticAntifreezeFullPageState createState() => _PlasticAntifreezeFullPageState();
}
