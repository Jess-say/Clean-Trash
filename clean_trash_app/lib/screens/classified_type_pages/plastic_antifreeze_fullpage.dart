...
class PlasticAntifreezeFullPage extends StatefulWidget {
  final String recyclable;

  const PlasticAntifreezeFullPage({Key? key, required this.recyclable})
      : super(key: key);

  @override
  _PlasticAntifreezeFullPageState createState() =>
      _PlasticAntifreezeFullPageState();
}

class _PlasticAntifreezeFullPageState extends State<PlasticAntifreezeFullPage> {
  @override
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              ...
                              child:
                                  Image.asset('assets/images/antifreeze1.jpg'),
                            ),
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child:
                                  Image.asset('assets/images/antifreeze2.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child:
                                  Image.asset('assets/images/antifreeze3.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                              side: const BorderSide(
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child:
                                  Image.asset('assets/images/antifreeze4.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                              //side: const BorderSide(color: Color.fromARGB(255, 255, 254, 254), width: 1),
                              borderRadius: BorderRadius.circular(10),
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              widget.recyclable == "True"
                                  ? "Do not throw antifreeze down the drain. Take it to the HHW Facility for recycling."
                                  : "Place in waste bin.",
                              style: TextStyle(
                                fontSize: 18,
                                color: Colors.grey[500],
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    firestoreInstance
                        ...
                        .update({"plastic": FieldValue.increment(1)}).then((_) {
                      print("success!");
                    });
                    showDialog(
