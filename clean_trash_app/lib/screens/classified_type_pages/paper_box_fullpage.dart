...
class PaperboxFullPage extends StatefulWidget {
  final String recyclable;

  const PaperboxFullPage({Key? key, required this.recyclable}) : super(key: key);
  
  @override
  _PaperboxFullPageState createState() => _PaperboxFullPageState();
}

class _PaperboxFullPageState extends State<PaperboxFullPage> {
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child:
                              Image.asset('assets/images/ritz.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                              side: const BorderSide(
