...
class PaperBagFullPage extends StatefulWidget {
  final String recyclable;

  const PaperBagFullPage({Key? key, required this.recyclable})
      : super(key: key);

  @override
  _PaperBagFullPageState createState() => _PaperBagFullPageState();
}

class _PaperBagFullPageState extends State<PaperBagFullPage> {
  @override
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              ...
                              child:
                                  Image.asset('assets/images/paper_bag1.jpg'),
                            ),
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child:
                                  Image.asset('assets/images/paper_bag2.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child:
                                  Image.asset('assets/images/paper_bag3.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                              side: const BorderSide(
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child:
                                  Image.asset('assets/images/paper_bag4.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                              //side: const BorderSide(color: Color.fromARGB(255, 255, 254, 254), width: 1),
                              borderRadius: BorderRadius.circular(10),
      ...
      Expanded(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Place bag in recycling bin. Please note if paper bag contained food only recycle clean bags not stained and dirty bags.",
              style: TextStyle(
                fontSize: 18,
                color: Colors.grey[500],
              ),
