...
class PlasticBottleFullPage extends StatefulWidget {
  final String recyclable;

  const PlasticBottleFullPage({Key? key, required this.recyclable})
      : super(key: key);

  @override
  _PlasticBottleFullPageState createState() => _PlasticBottleFullPageState();
}

class _PlasticBottleFullPageState extends State<PlasticBottleFullPage> {
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              ...
                              child: Image.asset(
                                  'assets/images/plastic_2liter.jpg'),
                            ),
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child: Image.asset(
                                  'assets/images/plastic_bottle1.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child:
                                  Image.asset('assets/images/plastic_soda.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                              side: const BorderSide(
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child: Image.asset(
                                  'assets/images/plastic_juice.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                              //side: const BorderSide(color: Color.fromARGB(255, 255, 254, 254), width: 1),
                              borderRadius: BorderRadius.circular(10),
