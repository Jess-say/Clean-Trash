...
class MagazineFullPage extends StatefulWidget {
  final String recyclable;

  const MagazineFullPage({Key? key, required this.recyclable})
      : super(key: key);

  @override
  _MagazineFullPageState createState() => _MagazineFullPageState();
}

class _MagazineFullPageState extends State<MagazineFullPage> {
  @override
                      ...
                      children: [
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              ...
                              child: Image.asset('assets/images/magazine1.jpg'),
                            ),
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child: Image.asset('assets/images/magazine2.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                              side: const BorderSide(
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child: Image.asset('assets/images/magazine3.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                              //side: const BorderSide(color: Color.fromARGB(255, 255, 254, 254), width: 1),
                              borderRadius: BorderRadius.circular(10),
