...
class NewspaperFullPage extends StatefulWidget {
  final String recyclable;

  const NewspaperFullPage({Key? key, required this.recyclable}) : super(key: key);
  
  @override
  _NewspaperFullPageState createState() => _NewspaperFullPageState();
}

class _NewspaperFullPageState extends State<NewspaperFullPage> {
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child:
                              Image.asset('assets/images/newspaper2.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                              side: const BorderSide(
      ...
      Expanded(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Place in recycling bin for paper. Please note some pre approved junk mail may have some info consider blacking out before recycling.",
              style: TextStyle(
                fontSize: 18,
                color: Colors.grey[500],
              ),
