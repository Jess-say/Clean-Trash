...
class PlasticSodaFullPage extends StatefulWidget {
  final String recyclable;

  const PlasticSodaFullPage({Key? key, required this.recyclable})
      : super(key: key);

  @override
  _PlasticSodaFullPageState createState() => _PlasticSodaFullPageState();
}

class _PlasticSodaFullPageState extends State<PlasticSodaFullPage> {
  @override
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child: Image.asset(
                                  'assets/images/plastic_soda2.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child: Image.asset(
                                  'assets/images/plastic_soda1.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                              //side: const BorderSide(color: Color.fromARGB(255, 255, 254, 254), width: 1),
                              borderRadius: BorderRadius.circular(10),
