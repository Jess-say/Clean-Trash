...
class MetalHangerFullPage extends StatefulWidget {
  ...
  const MetalHangerFullPage({Key? key, required this.recyclable})
      : super(key: key);
...
class _MetalHangerFullPageState extends State<MetalHangerFullPage> {
  @override
                      ...
                      children: [
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              ...
                              child: Image.asset('assets/images/hanger.jpg'),
                            ),
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child: Image.asset('assets/images/hanger1.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                        ...
                        Container(
                          ...
                          child: Card(
                            child: Container(
                              padding: const EdgeInsets.all(4.0),
                              child: Image.asset('assets/images/hanger2.jpg'),
                            ),
                            shape: RoundedRectangleBorder(
                              side: const BorderSide(
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              widget.recyclable == "True"
                                  ? "Place in appropriate bin for recycling."
                                  : "Place in waste bin.",
                              style: TextStyle(
                                fontSize: 18,
                                color: Colors.grey[500],
